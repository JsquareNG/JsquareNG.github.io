<template>
                            ...
                            <div class="input-group justify-content-center text-align-center">
                                <div class="col-md-3 col-11 mt-1">
                                    <select id="eduLevel" class="form-select form-select-lg form-field filter-left border border-warning border-4 shadow-none" aria-label="Default select example" v-model="filter.level">
                                        <option value="any">Education Level (Any)</option>
                                ...
                                <div class="col-md-3 col-11 mt-1">
                                    <select id="subject" class="form-select form-select-lg form-field border border-warning border-4 shadow-none" aria-label="Default select example" v-model="filter.subject">
                                        <option value="any">Subject (Any)</option>
                                ...
                                <div class="col-md-3 col-11 mt-1">
                                    <input  @keydown.enter.prevent="preventSubmitByEnter" class="form-control form-control-lg form-field border border-warning border-4 shadow-none" type="number" id="distanceRadius" placeholder="Distance Radius (km)" min="1" v-model="filter.distance">
                                </div>
    ...
    <div class="container-fluid my-5">
        <div class="row py-2 mx-2 justify-content-center">
            <!-- START HERE -->
                    ...
                    <div v-else class="row  justify-content-around text-center">
                        ...
                        <div class="col-lg-3 col-md-5 col-12 my-3" v-for="tutor in recommendedTutors" :key="tutor.userID">
                            ...
                            <div class="card-content">
                                ...
                                <p class="distanceInfor"><i class="fa-solid fa-train" ></i>      {{ tutor.distanceBetween === '0.0' ? 'Same area' : tutor.distanceBetween + ' km away from you' }}</p>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Book a Tuition Session with <strong>{{tutor.name}}</strong></h5>
                            ...
                            <div class="card-body">
                                ...
                                <div v-if="request.status == 'rejected'" class="container-fluid" style="border-radius: 25px;">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <button @click="removeRequest(request.id)" class="btn btn-primary">Acknowledge</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                snap.forEach((doc) => {
                    ...
                    // if (this.filter.subject === 'any' || tutorData.subjects.includes(this.filter.subject)) {
                        ...
                        //     distance = (distance/1000).toFixed(1)
                            ...
                            // if(this.filter.distance && distance <= this.filter.distance) {
                                // tutorData.distanceBetween = distance;
                                // this.getTuitionTimeslots(tutorData);
                            // }
