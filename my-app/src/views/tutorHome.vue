                                ...
                                <div class="modal-content">
                                    ...
                                    <form >
                                        <div class="modal-body">
                                            ...
                                            <select v-model="form.time" class="form-control" id="preferredTime" name="preferredTime" required>
                ...
                <div class="p-3 bg-white border">
                    ...
                    <div v-for="confirmed of confirmedRequests" :key="confirmed.id" class="card mb-3 text-center">
                        <div class="card-body">
                            ...
                            <h6 class="card-text"><i class="fa-solid fa-location-dot" style="color: #ff0f0f;"></i>      {{ confirmed.nearestMRT.slice(0, -3) }}</h6>
